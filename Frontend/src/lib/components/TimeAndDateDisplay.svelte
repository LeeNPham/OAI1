...
<div
	transition:slide
	class="text-cyan-300 w-[200px] bg-cyan-300/10 shadow-2xl shadow-cyan-300/20 text-center flex flex-col gap-1 absolute top-0 -left-[460px] p-4 pr-2 border border-x-4 border-y-2 border-cyan-300 rounded-l-3xl rounded-b-3xl"
>
	<div
